...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new custom_date.Button();
        cmdTu = new custom_date.Button();
        cmdWe = new custom_date.Button();
        cmdTh = new custom_date.Button();
        cmdFr = new custom_date.Button();
        cmdSa = new custom_date.Button();
        cmdSu = new custom_date.Button();
        cmd1 = new custom_date.Button();
        cmd2 = new custom_date.Button();
        cmd3 = new custom_date.Button();
        cmd4 = new custom_date.Button();
        cmd5 = new custom_date.Button();
        cmd6 = new custom_date.Button();
        cmd7 = new custom_date.Button();
        cmd8 = new custom_date.Button();
        cmd9 = new custom_date.Button();
        cmd10 = new custom_date.Button();
        cmd11 = new custom_date.Button();
        cmd12 = new custom_date.Button();
        cmd13 = new custom_date.Button();
        cmd14 = new custom_date.Button();
        cmd15 = new custom_date.Button();
        cmd16 = new custom_date.Button();
        cmd17 = new custom_date.Button();
        cmd18 = new custom_date.Button();
        cmd19 = new custom_date.Button();
        cmd20 = new custom_date.Button();
        cmd21 = new custom_date.Button();
        cmd22 = new custom_date.Button();
        cmd23 = new custom_date.Button();
        cmd24 = new custom_date.Button();
        cmd25 = new custom_date.Button();
        cmd26 = new custom_date.Button();
        cmd27 = new custom_date.Button();
        cmd28 = new custom_date.Button();
        cmd29 = new custom_date.Button();
        cmd30 = new custom_date.Button();
        cmd31 = new custom_date.Button();
        cmd32 = new custom_date.Button();
        cmd33 = new custom_date.Button();
        cmd34 = new custom_date.Button();
        cmd35 = new custom_date.Button();
        cmd36 = new custom_date.Button();
        cmd37 = new custom_date.Button();
        cmd38 = new custom_date.Button();
        cmd39 = new custom_date.Button();
        cmd40 = new custom_date.Button();
        cmd41 = new custom_date.Button();
        cmd42 = new custom_date.Button();
    ...
    private custom_date.Button cmd1;
    private custom_date.Button cmd10;
    private custom_date.Button cmd11;
    private custom_date.Button cmd12;
    private custom_date.Button cmd13;
    private custom_date.Button cmd14;
    private custom_date.Button cmd15;
    private custom_date.Button cmd16;
    private custom_date.Button cmd17;
    private custom_date.Button cmd18;
    private custom_date.Button cmd19;
    private custom_date.Button cmd2;
    private custom_date.Button cmd20;
    private custom_date.Button cmd21;
    private custom_date.Button cmd22;
    private custom_date.Button cmd23;
    private custom_date.Button cmd24;
    private custom_date.Button cmd25;
    private custom_date.Button cmd26;
    private custom_date.Button cmd27;
    private custom_date.Button cmd28;
    private custom_date.Button cmd29;
    private custom_date.Button cmd3;
    private custom_date.Button cmd30;
    private custom_date.Button cmd31;
    private custom_date.Button cmd32;
    private custom_date.Button cmd33;
    private custom_date.Button cmd34;
    private custom_date.Button cmd35;
    private custom_date.Button cmd36;
    private custom_date.Button cmd37;
    private custom_date.Button cmd38;
    private custom_date.Button cmd39;
    private custom_date.Button cmd4;
    private custom_date.Button cmd40;
    private custom_date.Button cmd41;
    private custom_date.Button cmd42;
    private custom_date.Button cmd5;
    private custom_date.Button cmd6;
    private custom_date.Button cmd7;
    private custom_date.Button cmd8;
    private custom_date.Button cmd9;
    private custom_date.Button cmdFr;
    private custom_date.Button cmdMo;
    private custom_date.Button cmdSa;
    private custom_date.Button cmdSu;
    private custom_date.Button cmdTh;
    private custom_date.Button cmdTu;
    private custom_date.Button cmdWe;
