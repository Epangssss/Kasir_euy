...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new custom_date.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new custom_date.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new custom_date.Button();
        cmdPrevious = new custom_date.Button();
        slide = new custom_date.Slider();
    ...
    private custom_date.Button cmdForward;
    private custom_date.Button cmdMonth;
    private custom_date.Button cmdPrevious;
    private custom_date.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private custom_date.Slider slide;
